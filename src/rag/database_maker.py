...
def create_database(db_name=None, user=None, password=None, host=None, port=None):
    ...
    try:
        ...
        logger.info(f"データベース作成中にエラーが発生しました: {e}")
        raise
...
def enable_pgvector_extension(db_name=None, user=None, password=None, host=None, port=None):
    ...
    try:
        ...
        cur.close()
        conn.close()
        logger.info(f"データベース '{db_name}' でpgvector拡張機能を有効にしました。")
    except Exception as e:
        logger.info(f"pgvector拡張機能の有効化中にエラーが発生しました: {e}")
        raise
...
def create_rag_table(db_name=None, user=None, password=None, host=None, port=None):
    ...
    try:
        ...
        cur.close()
        conn.close()
        logger.info("rag_documentsテーブルを作成しました。")
    except Exception as e:
        logger.info(f"rag_documentsテーブルの作成中にエラーが発生しました: {e}")
        raise
...
def create_vector_table(db_name=None, user=None, password=None, host=None, port=None):
    ...
    try:
        ...
        cur.close()
        conn.close()
        logger.info("vector_embeddingsテーブルを作成しました。")
    except Exception as e:
        logger.info(f"vector_embeddingsテーブルの作成中にエラーが発生しました: {e}")
        raise
